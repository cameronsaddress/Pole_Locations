...
FILTER_MAX_ROAD_DISTANCE_M = float(os.getenv("FILTER_MAX_ROAD_DISTANCE_M", "200.0"))
...
FUSION_NEW_FLAGGED_CONFIDENCE_THRESHOLD = 0.20
FUSION_AUTO_VERIFY_CONFIDENCE_THRESHOLD = 0.50
FUSION_NEW_FLAGGED_MAX_ROAD_DIST_M = 150.0
